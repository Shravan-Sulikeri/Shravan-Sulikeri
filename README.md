...
I’m a **data-driven engineer** passionate about designing and operationalizing **scalable data and machine learning systems**.  
My work blends **data engineering**, **ML pipeline development**, and **cloud automation**, with a strong focus on building reproducible, production-ready analytics platforms.

**Core strengths:**  
- **Python**, **SQL**, **PySpark**, and **TensorFlow/Keras** for ML modeling and automation  
- **Databricks**, **Azure DevOps**, **MLflow**, and **Power BI** for cloud analytics and monitoring  
- Expertise in **ETL pipeline design**, **data transformation (Bronze–Silver–Gold)**, and **MLOps lifecycle management**  
- Experienced with **Docker**, **GitHub Actions**, and **PowerShell** for CI/CD and automation  

I’m passionate about bridging ML experimentation with real-world deployment — turning data into insight and automation into impact.
...
![LightGBM](https://img.shields.io/badge/LightGBM-3FB950?logo=lightgbm&logoColor=white)
![CatBoost](https://img.shields.io/badge/CatBoost-FFCA28?logo=catboost&logoColor=black)
